...
interface EqSettingsProps {
    ...
    onToggleAiDj: (enabled: boolean) => void;
    onBack: () => void;
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
            ...
            <EqControls bands={bands} onEqChange={onEqChange} isEnabled={isEqEnabled} />
            </div>
        ...
        <div className="w-full p-6 bg-black/30 rounded-lg border border-green-500/20 shadow-[0_0_15px_rgba(57,255,20,0.2)]">
            ...
            <div className="flex items-center mt-4">
                <Switch label="AI DJ Announcer" checked={isAiDjEnabled} onChange={onToggleAiDj} accentColor="purple" />
            </div>
            <p className="text-sm text-gray-400 mt-2 pl-16">
                Let an AI DJ introduce your songs and radio stations.
            </p>
        </div>
