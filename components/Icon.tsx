...
interface IconProps {
  name: 'play' | 'pause' | 'next' | 'previous' | 'heart-filled' | 'heart-outline' | 'upload' | 'music-note' | 'pause-circle' | 'volume-high' | 'volume-off' | 'eq' | 'radio' | 'settings' | 'amp' | 'plus' | 'close' | 'share' | 'book' | 'trash' | 'robot' | 'image' | 'expand' | 'stop-circle';
  className?: string;
  ...
  const icons = {
    ...
    'robot': (
        <svg className={className} style={style} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2a2 2 0 0 0-2 2v2H8a2 2 0 0 0-2 2v2H4a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-2v-2a2 2 0 0 0-2-2h-2V4a2 2 0 0 0-2-2zm-3 12a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm6 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" />
        </svg>
    ),
    'image': (
      <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    'stop-circle': (
      <svg className={className} style={style} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8 9a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 01-1 1h-2a1 1 0 01-1-1V9z" clipRule="evenodd" />
      </svg>
    ),
  };
